          ...
          <style
            dangerouslySetInnerHTML={{
              ...
              :root {
                ...
                --muted-foreground: ${theme.light?.["muted-foreground"] || "oklch(0.45 0.03 175)"};
                ...
                --accent-foreground: ${theme.light?.["accent-foreground"] || "oklch(0.22 0.04 175)"};
              }
              .dark {
                ...
                --muted-foreground: ${theme.dark?.["muted-foreground"] || "oklch(0.65 0.03 175)"};
                ...
                --accent-foreground: ${theme.dark?.["accent-foreground"] || "oklch(0.18 0.02 175)"};
              }
            `,
            }}
          />
